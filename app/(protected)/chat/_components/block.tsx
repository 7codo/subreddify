...
import type { Document, Suggestion, Vote } from "@/lib/db/schemas";
      ...
      {block.isVisible && (
        ...
        >
          ...
          >
            ...
            <div
              className={cn(
                "dark:bg-muted bg-background h-full overflow-y-scroll !max-w-full pb-40 items-center           py-8 md:p-20 px-4"
              )}
            >
              <div className={cn("flex flex-row mx-auto max-w-[600px]")}>
